...
public class SportsFragment extends BaseFragment implements NewsRecyclerAdapter.NewsRecyclerAdapterOnClickHandler{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CONTENT_QUERY_URI = NewsContract.SportsEntry.CONTENT_URI;
    ...
    public void onClick(int newsId) {
        ...
        Uri uri = NewsContract.SportsEntry.CONTENT_URI.buildUpon().appendPath(String.valueOf(newsId)).build();
        intent.setData(uri);
