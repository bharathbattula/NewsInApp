...
public class ScienceActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    NewsAdapter adapter;
    ListView listNews;
    ...
    private String REQUEST_URL="https://newsapi.org/v1/articles?source=national-geographic&sortBy=top&apiKey=5bfecae129c44fa389435196ec54adf1";
    @Override
