...
public class TechnologyAvtivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String REQUEST_URL="https://newsapi.org/v1/articles?source=the-verge&sortBy=top&apiKey=5bfecae129c44fa389435196ec54adf1";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_technology_avtivity);
